...
cat > /etc/sysctl.d/10-perf.conf <<EOF
### KERNEL TUNING ###
...
cat > /etc/sysctl.d/10-humio.conf <<EOF
...
sudo zfs create -o com.sun:auto-snapshot=false -o mountpoint=/var/humio tank/var/humio
sudo zfs create -o com.sun:auto-snapshot=false -o mountpoint=/var/kafka tank/var/kafka
sudo zfs create -o com.sun:auto-snapshot=false -o mountpoint=/var/lib/zookeeper tank/var/zookeeper
