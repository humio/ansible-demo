...
declare -r ip_address=$(python -c 'import requests; print requests.get("http://metadata.google.internal/computeMetadata/v1beta1/instance/network-interfaces/0/ip", timeout=5).content')
